...
namespace CefSharp.OffScreen
{
    ...
    public partial class ChromiumWebBrowser : IRenderWebBrowser
    {
        ...
        public bool IsDisposed => Interlocked.CompareExchange(ref disposeSignaled, 1, 1) == 1;

        /// <summary>
        /// A flag that indicates whether the WebBrowser is initialized (true) or not (false).
        /// </summary>
        /// <value><c>true</c> if this instance is browser initialized; otherwise, <c>false</c>.</value>
        public bool IsBrowserInitialized => InternalIsBrowserInitialized();
        ...
        public Bitmap ScreenshotOrNull(PopupBlending blend = PopupBlending.Main)
        {
            ...
            if (!(RenderHandler is DefaultRenderHandler renderHandler))
            {
        ...
        public Task<Bitmap> ScreenshotAsync(bool ignoreExistingScreenshot = false, PopupBlending blend = PopupBlending.Main)
        {
            ...
            {
                void afterPaint(object sender, OnPaintEventArgs e)
                {
        ...
        /// </summary>
        /// <returns>ScreenInfo.</returns>
        protected virtual ScreenInfo? GetScreenInfo() => RenderHandler?.GetScreenInfo();

        /// <summary>
        /// Gets the view rect (width, height)
        /// </summary>
        /// <returns>ViewRect.</returns>
        Rect IRenderWebBrowser.GetViewRect() => GetViewRect();
        ...
        bool IRenderWebBrowser.GetScreenPoint(int viewX, int viewY, out int screenX, out int screenY) => GetScreenPoint(viewX, viewY, out screenX, out screenY);
        ...
        bool IRenderWebBrowser.StartDragging(IDragData dragData, DragOperationsMask mask, int x, int y) => RenderHandler?.StartDragging(dragData, mask, x, y) ?? false;
        ...
        void IRenderWebBrowser.OnPopupShow(bool show) => RenderHandler?.OnPopupShow(show);

        /// <summary>
        /// Called when the browser wants to move or resize the popup widget.
        /// </summary>
        /// <param name="rect">contains the new location and size in view coordinates. </param>
        void IRenderWebBrowser.OnPopupSize(Rect rect) => RenderHandler?.OnPopupSize(rect);
        ...
        void IRenderWebBrowser.OnVirtualKeyboardRequested(IBrowser browser, TextInputMode inputMode) => RenderHandler?.OnVirtualKeyboardRequested(browser, inputMode);
        ...
        void IWebBrowserInternal.SetTitle(TitleChangedEventArgs args) => TitleChanged?.Invoke(this, args);
