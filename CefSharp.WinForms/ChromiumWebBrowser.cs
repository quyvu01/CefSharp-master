...
namespace CefSharp.WinForms
{
    ...
    public partial class ChromiumWebBrowser : Control, IWebBrowserInternal, IWinFormsWebBrowser
    {
        ...
        public new bool IsDisposed => Interlocked.CompareExchange(ref disposeSignaled, 1, 1) == 1;
        ...
        private void InternalDispose(bool disposing)
        {
            if (disposing)
            {
                ...
                SetHandlersToNullExceptLifeSpan();
        ...
        /// </summary>
        internal void HideInternal() => ResizeBrowser(0, 0);

        /// <summary>
        /// Show the browser (called after previous minimised)
        /// </summary>
        internal void ShowInternal() => ResizeBrowser(Width, Height);
