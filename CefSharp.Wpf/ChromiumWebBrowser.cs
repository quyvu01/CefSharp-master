...
namespace CefSharp.Wpf
{
    ...
    public partial class ChromiumWebBrowser : Control, IRenderWebBrowser, IWpfWebBrowser
    {
        ...
        void IWebBrowserInternal.SetTitle(TitleChangedEventArgs args) => UiThreadRunAsync(() => SetCurrentValue(TitleProperty, args.Title));

        /// <summary>
        /// Sets the tooltip text.
        /// </summary>
        /// <param name="tooltipText">The tooltip text.</param>
        void IWebBrowserInternal.SetTooltipText(string tooltipText) => UiThreadRunAsync(() => SetCurrentValue(TooltipTextProperty, tooltipText));
        ...
        private void OnLoaded(object sender, RoutedEventArgs routedEventArgs)
        {
            ...
            tooltipTimer = new DispatcherTimer(TimeSpan.FromSeconds(0.5), DispatcherPriority.Render, OnTooltipTimerTick, Dispatcher)
            {
                IsEnabled = false
            };
